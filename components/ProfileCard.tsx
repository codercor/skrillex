      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="absolute bottom-0 left-1/2 -translate-x-1/2 will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc(-50% + 50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scaleY(calc(1 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1 + (var(--pointer-from-left) - 0.5) * 0.01))',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden',
            ...
            >
              <div className="w-full absolute flex flex-col justify-end" style={{ top: 'auto', bottom: '0', height: '100%', display: 'flex', gridArea: 'auto', padding: '0 8px 24px 8px' }}>
                <h3
                  className="font-semibold m-0"
                  style={{
                    fontSize: 'clamp(0.85rem, 5cqw, 1.4rem)',
                    color: 'white',
                ...
                <p
                  className="font-medium mx-auto w-full px-2"
                  style={{
                    position: 'relative',
                    fontSize: 'clamp(0.6rem, 3.5cqw, 0.8rem)',
